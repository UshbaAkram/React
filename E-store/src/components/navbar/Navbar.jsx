            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === 'ushbaakram@gmail.com' ? <div className="flow-root">
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    <img
                      src="https://tse1.mm.bing.net/th?id=OIP.jvgz9UXgoLt6kpU8uFIBYgHaFj&pid=Api"
                      alt="pak"
                      className="block h-auto w-5 flex-shrink-0"
                    />
                    <span
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="/signup" className="flex items-center text-gray-700 ">
                    {/* <img
                      
                      src="https://overreacted.io/static/profile-pic-c715447ce38098828758e525a1128b87.jpg"
                      alt="Dan_Abromov"
                    /> */}
                    <CiUser className="bold inline-block w-8 h-7 rounded-full"/>
                  </a>
                </div>
